...
// ── Configuration ──────────────────────────────────────────────────────
const HISTORY_PATH = (0, node_path_1.join)(__dirname, "posted.json");
...
function buildCaption(quote, author, brand, hashtags, locations) {
...
function renderQuoteSvg(lines, author, brand, imgWidth, imgHeight, imgBase64) {
    const lineH = 76;
    const lineGap = 12;
